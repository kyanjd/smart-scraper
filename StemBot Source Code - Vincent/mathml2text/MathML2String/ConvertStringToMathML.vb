...
Public Class ConvertStringToMathML
    Shared CI As Globalization.CultureInfo
    Public Shared ReadOnly vSubstitute() As String = {"\[", "\]", "\{", "\}",
                             ":", "÷", "–", Chr(&HBC), Chr(&HBD), Chr(&HBE), Chr(&HB2), Chr(&HB3),
    ...
    Public Shared Function ConvertToMathML(s As String,
        ...
        Try
            ...
            Dim sOp As String = "(?<op> |∈|,|-|\=|\±|\<|\>|≠|≈|≤|≥|\+|ζ|\*|▒|(?<sum>∑|∫|∏)|Γ|\/|\^|_|nand|mod|and|nor|xor|not|or|%|!|\(|\))"
