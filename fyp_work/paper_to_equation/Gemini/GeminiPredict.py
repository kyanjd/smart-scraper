...
class GeminiPredict():
    def __init__(self, api_key_name, filename, model_name):
        ...
        if key:
            ...
            print(f"API key not found. Please ensure it is set as an environment variable named {api_key_name}.")
        genai.configure(api_key=key)

    def predict_from_file(self, filename=None, model_name=None):  
